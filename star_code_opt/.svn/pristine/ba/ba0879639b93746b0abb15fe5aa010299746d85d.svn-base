...
{
	strErrorMsg	=	" "+dbLabelBean.getLabel("message.designation.thedesignationenteredalreadyexists",strsesLanguage);
}
...
{
	strErrorMsg	=	" "+dbLabelBean.getLabel("message.designation.datacannotbedeletedthisdesignationhassomereference",strsesLanguage);
}

if(strError.trim().equals("7"))
{
	strErrorMsg	=	" "+dbLabelBean.getLabel("message.designation.thedesignation",strsesLanguage)+" ";
}
...
<table width="100%" height="45" border="0" align="center" cellpadding="0" cellspacing="0"  class="bodyline-top">
  <tr> 
    <td width="86%" height="45" class="pageHead">&nbsp;&nbsp;<%=dbLabelBean.getLabel("submenu.master.designation",strsesLanguage)%> >> <%=strType%> </td>
