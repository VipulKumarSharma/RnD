					...
					<tr align="right">
						<td>
							<ul id="list-nav">
								...
								%>
								<li><a href="#"
									onClick="MM_openBrWindow('T_TravelRequisitionDetails_D.jsp?purchaseRequisitionId=<%=requestInfoObj.getLinkedTravelRequest()%>&traveller_Id=<%=strTravellerId%>&travelType=D','LinkedCancelledRequest<%=requestInfoObj.getLinkedTravelRequest()%>','scrollbars=yes,resizable=yes,width=975,height=550')"><%=dbLabelBean.getLabel(
				...
				<table width="100%" border="1" cellpadding="2" cellspacing="0"
					...
					<tr>
						...
						<td class="reportCaption" rowspan="2" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.totalamount",
							strsesLanguage)%>(<%=dbLabelBean.getLabel("label.requisition.inr",strsesLanguage)%>)</td>
		...
		<tr>
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					style="border-collapse: collapse">
					<tr>
						<td height="0" colspan="4" class="reportHeading"><%=dbLabelBean.getLabel(
						"label.createrequest.identityproofdetails",
						strsesLanguage)%></td>
					</tr>
					<tr>
						<td class="reportCaption" width="15%"><%=dbLabelBean.getLabel("label.global.proofofidentity",
						strsesLanguage)%></td>
						<td class="reportdata" width="35%"><%=traveller.getProofIdentityName()%></td>
						<td class="reportCaption" width="15%"><%=dbLabelBean.getLabel(
						"label.createrequest.identityproofnumber",
						strsesLanguage)%></td>
						<td class="reportdata" width="35%"><%=traveller.getProofIdentityNumber()%></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					<tr>
						...
						<td class="reportCaption" width="25%"><%=dbLabelBean.getLabel(
							"label.global.hotelchain", strsesLanguage)%></td>
						<td class="reportCaption" width="25%"><%=dbLabelBean.getLabel(
							"label.requestdetails.number", strsesLanguage)%></td>
					</tr>
					<%
		...
		<tr>
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					style="border-collapse: collapse">
					<tr>
						<td colspan="4" class="reportHeading"><%=dbLabelBean.getLabel("link.approverequest.comments",
						strsesLanguage)%></td>
					</tr>
					<tr>
						<td class="reportCaption" width="4%" style="text-align: center;" nowrap="nowrap"><%=dbLabelBean.getLabel("label.global.sno",
						strsesLanguage)%></td>
						<td class="reportCaption" width="46%" align="left"><%=dbLabelBean.getLabel("link.approverequest.comments",
						strsesLanguage)%></td>
			...
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					<tr>
						...
						strsesLanguage)%></td>
						<td class="reportCaption" width="46%" align="left" valign="top"><%=dbLabelBean.getLabel("link.approverequest.comments",
						strsesLanguage)%></td>
