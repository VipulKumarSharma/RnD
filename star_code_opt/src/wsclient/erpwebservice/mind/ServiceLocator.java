...
public class ServiceLocator extends org.apache.axis.client.Service implements wsclient.erpwebservice.mind.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://mindnodas84/eMProNET/services/ExpenseService.asmx";
    ...
    public wsclient.erpwebservice.mind.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public wsclient.erpwebservice.mind.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            wsclient.erpwebservice.mind.ServiceSoapStub _stub = new wsclient.erpwebservice.mind.ServiceSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "http://mindnodas84/eMProNET/services/ExpenseService.asmx";
    ...
    public wsclient.erpwebservice.mind.ServiceSoap getServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public wsclient.erpwebservice.mind.ServiceSoap getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            wsclient.erpwebservice.mind.ServiceSoap12Stub _stub = new wsclient.erpwebservice.mind.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (wsclient.erpwebservice.mind.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                wsclient.erpwebservice.mind.ServiceSoapStub _stub = new wsclient.erpwebservice.mind.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (wsclient.erpwebservice.mind.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                wsclient.erpwebservice.mind.ServiceSoap12Stub _stub = new wsclient.erpwebservice.mind.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
