...
$.fn.extend({
	...
	navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch, pView) {
		o = $.extend({
			edit: true,
			editicon: "row_edit.gif?buildstamp=2_0_0",

			add: true,
			addicon:"row_add.gif?buildstamp=2_0_0",

			del: true,
			delicon:"row_delete.gif?buildstamp=2_0_0",

			search: true,
			searchicon:"find.gif?buildstamp=2_0_0",

			refresh: true,
			refreshicon:"refresh.gif?buildstamp=2_0_0",
			refreshstate: 'firstpage',

			position : "left",
			closeicon: "ico-close.gif?buildstamp=2_0_0",
			closeOnEscape : true,
			view: true,
			viewicon : "row_view.gif?buildstamp=2_0_0"
		}, $.jgrid.nav, o ||{});
		return this.each(function() {       
