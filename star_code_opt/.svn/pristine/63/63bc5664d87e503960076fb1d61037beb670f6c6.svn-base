...
function checkData(f1)
{
	...
	if(f1.noOfColumn.value == "")
	{
		alert("Please insert the no of columns");
		f1.noOfColumn.focus();
		return false;
	}
	f1.submit();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<ul class="pagebullet">
      <li class="pageHead">INPUT QUERY</li>
    </ul></td>
...
<table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" class="formborder">
	<form name="frm" action="TESTQUERY_POST.jsp">
		...
		<tr>
			<TD width="52%" align="left">INPUT QUERY</TD>
			<TD> <input type="text" name="inputQuery" size="100"/></TD>
		</tr>
		<tr>
			<TD width="52%" align="left">COLUMN SIZE</TD>
			<TD><input type="text" name="noOfColumn" size="10"/></TD>
		</tr>
		<tr align="center">
