...
/*	 System.out.println("strRequstionNo=======123=========="+strRequstionNo); 
 ...
 if(strTravelType.equals("INT")){
	...
	{
		System.out.println("Error in T_TravelReqSearchResults.jsp======="+e);
	}
...
<div id="dv" style="width:99%; left:5px; height:90%; border-color:red; position: absolute; overflow: auto;" >
	<span id=main>
	
	<table width="100%" align="left" border="0" cellpadding="5" 
		cellspacing="1" class="formborder" style="border: thin;">  
