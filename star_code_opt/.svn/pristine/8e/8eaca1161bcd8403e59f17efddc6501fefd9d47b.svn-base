 ...
 *Author								:Shiv sharma 
 *Date of Creation 				:07 June 2007
 *Copyright Notice 		        :Copyright(C)2000 MIND.All rights reserved
 *Project	  			                :STAR
 *Operating environment     :Tomcat, sql server 2000 
 *Description 			             :This is java script filr for genrating  calender 
 *Modification 			             :modification done by jugnu sharma on 08-Jun-07 
			...
			if ( crossobj.visibility ==	"hidden" ) {
				...
				aTag = ctl
				  do {
		                ...
		                if (aTag != document.body && aTag != document.documentElement){
		                    toppos -= aTag.scrollTop;
		                    leftpos -= aTag.scrollLeft;		                    
		                }  
		                if(aTag.style.overflow != '' || aTag.style.overflowX != '' || aTag.style.overflowY != ''){break;}
