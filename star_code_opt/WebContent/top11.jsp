	    ...
	    <tr>
	      <td height="60" valign="top" background="images/header_bg.gif?buildstamp=2_0_0">
	        ...
	        <%  } %>
	          ...
	          <tr>
	            <td height="28"  colspan="<%=colspanCnt %>" valign="middle">
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">          
				    <tr>
	<%
	String link=null;
	...
	//System.out.println("strSqlStr--top11--->"+strSqlStr);
	...
	{   
	  ...
	  if(m_label!=null && m_label.trim().equalsIgnoreCase("label.mainmenu.reports"))
	  {
		...
		{
	%> 
					  <td width=<%=fltTotalWidth%> height="28">
					  <a class="menu" href="topMenuBuildUp.jsp?id=<%=m_label%>&travel_type=<%=strTravelType%>"><%=dbLabelBean.getLabel(m_label,strLangValue)%></a>			  </td>  
	<%
		}
	  ...
	  else if(m_label!=null && m_label.trim().equalsIgnoreCase("label.mainmenu.pendingforapproval"))
	  {
	 	
	%>
		<td width=<%=fltTotalWidth%> height="28"> 
	 <!--@Gaurav 09-March-2007 menuSize is for the All Pending Menu item made for chairman -->
						<a class="menuSize" href="T_approveTravelRequisitions_All.jsp" target="middle"><%=dbLabelBean.getLabel(m_label,strLangValue)%></a>
		</td>
	<%
	...
	%> 
					  <td width=<%=fltTotalWidth%> height="28">
					  <a class="menu" href="topMenuBuildUp.jsp?id=<%=m_label%>&travel_type=<%=strTravelType%>"><%=dbLabelBean.getLabel(m_label,strLangValue)%></a>
					  </td>  
	<%
	  }  		
	%>
