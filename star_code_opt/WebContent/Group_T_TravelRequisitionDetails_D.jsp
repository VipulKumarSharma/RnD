...
<%
	...
	if (reportFlag.equalsIgnoreCase("false") && strUserAccessCheckFlag.equals("420")) {
		...
		securityUtilityBean.registerUnauthAccessLog(Suser_id,
				...
				"Group_T_TravelRequisitionDetails_D.jsp",
				"Unauthorized Access");
					...
					<tr align="right">
						<td>
							<ul id="list-nav">
								...
								%>
								<li><a href="#"
									onClick="MM_openBrWindow('Group_T_TravelRequisitionDetails_D.jsp?purchaseRequisitionId=<%=requestInfoObj.getLinkedTravelRequest()%>&traveller_Id=<%=strTravellerId%>&travelType=D','LinkedCancelledRequest<%=requestInfoObj.getLinkedTravelRequest()%>','scrollbars=yes,resizable=yes,width=975,height=550')"><%=dbLabelBean.getLabel(
		...
		<tr>
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					style="border-collapse: collapse">
					<tr>
						<td height="0" colspan="12" class="reportHeading"><%=dbLabelBean
					...
					<tr>
						...
						.getLabel("label.requestdetails.totalamtrequired",
								strsesLanguage)%></td>
						<td class="reportCaption" width="12%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.proofofidentity",
						strsesLanguage)%></td>
						<td class="reportCaption" width="12%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.contactno",
						strsesLanguage)%></td>
					</tr>
					<%
					...
					<tr>
						...
						<td class="reportdata" width="12%"><%=user.getProofIdentityName() + " - "
									+ user.getProofIdentityNumber()%></td>
						<td class="reportdata" width="12%"><%=user.getContactNo()%></td>
					</tr>
					<%
						}
								}
				...
				<table width="100%" border="1" cellpadding="2" cellspacing="0"
					...
					<tr>
						<td height="0" colspan="10" align="left" class="reportHeading"><%=dbLabelBean.getLabel(
							"label.createrequest.advancerequired",
							strsesLanguage)%></td>
