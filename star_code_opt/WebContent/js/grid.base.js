...
$.fn.jqGrid = function( p ) {
	...
	mtype: "GET",
	imgpath: "",
	sortascimg: "sort_asc.gif?buildstamp=2_0_0",
	sortdescimg: "sort_desc.gif?buildstamp=2_0_0",
	firstimg: "first.gif?buildstamp=2_0_0",
	previmg: "prev.gif?buildstamp=2_0_0",
	nextimg: "next.gif?buildstamp=2_0_0",
	lastimg: "last.gif?buildstamp=2_0_0",
	altRows: true,
	selarrrow: [],
	savedRow: [],
	shrinkToFit: true,
		...
		if(ts.p.caption) {
			...
			if(ts.p.hidegrid===true) {
				$(".HeaderButton",grid.cDiv).toggle( function(){
					...
					$(grid.bDiv).hide();
					$(grid.hDiv).slideUp();
					$("img",this).attr("src",ts.p.imgpath+"down.gif?buildstamp=2_0_0");
					...
					$("img",this).attr("src",ts.p.imgpath+"up.gif?buildstamp=2_0_0");
