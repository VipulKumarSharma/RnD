...
<!-- Start of body -->
    ...
    <tr align="left">
      <td  colspan="4" class="selectedmenubg"><ul class="pagebullet">
        <% if (strFlag == null){ %>
          <li class="pageHead">Register Yourself </li>
        <% } else {%>
        </ul>
    ...
    <tr align="left">
      <td width="181" class="formtr1"><font size="" color="#FF3300">*</font>First Name<br> 
      (As per passport)</td>
      <td width="317" class="formtr1"><input type="text" name="firstName" size="25" onKeyUp="return test1('firstName', 29, 'c')" maxlength="30" class="textBoxCss" /></td>
      <script language="javascript">
			document.frm.firstName.value ="<%=txtFirstName%>";
			</script>
      <td width="175" class="formtr1"><font size="" color="#FF3300"></font>Last Name<br> 
      (As per passport) </td>
      <td width="493" class="formtr1"><input type="text" name="lastName" size="25" onKeyUp="return test1('lastName', 29, 'c')" maxlength="30" class="textBoxCss" /></td>
      <script language="javascript">
	...
	<tr align="left">
	  <td class="formtr1" colspan='2'><font size='1' color='red'>minimum 8 character are required for Password and Confirm Password.</font>
	  </td>
...
%>
	      <option value="-1" class="formtr1">Select Your Unit </option>
<%
 		 while(rs.next()) 
		 { 
%>
...
%>
      ...
      <td class="formtr1"><font size="" color="#FF3300">*</font> Employee Code</td>
    ...
    <tr align="center">
      <td width="181" class="formtr1">Passport No</td>
      ...
      <td width="175" class="formtr1">Emigration Clearance Required</td>
      <td width="493" class="formtr1"> 
...
-->
    ...
    <tr align="left">
      ...
      <td class="formtr1"><input type="text" name="passport_issue_date" size="10" maxlength="10" class="textBoxCss" onFocus="javascript:vDateType='DD/MM/YYYY'" onKeyUp="DateFormat(this,this.value,event,false,'DD/MM/YYYY','Invalid Date.Please Re-Enter')" onBlur="DateFormat(this,this.value,event,true,'DD/MM/YYYY','Invalid Date.Please Re-Enter')"  onChange="javascript:while(''+this.value.charAt(this.value.length-1)==' ')this.value=this.value.substring(0,this.value.length-1);">
       <!-- <a href="javascript:show_calendar('frm.passport_issue_date','a','a','DD/MM/YYYY');"onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;">
		...
		<!-- change done by shiv on  07-Jun-07 open -->  
    	 <a   onMouseOver="window.status='Date Picker';return true;"   onMouseOut="window.status='';return true;"  onclick="button_onclick(document.frm.passport_issue_date);" > <IMG   height=14 alt=Calender src="images/calender.png?buildstamp=2_0_0"  width=17></A>
		<!-- change done by shiv on  07-Jun-07 open -->  
		</td>
	  ...
	  <td class="formtr1"><input type="text" name="passport_expire_date" size="10" maxlength="50" class="textBoxCss" onFocus="javascript:vDateType='DD/MM/YYYY'" onKeyUp="DateFormat(this,this.value,event,false,'DD/MM/YYYY','Invalid Date.Please Re-Enter')" onBlur="DateFormat(this,this.value,event,true,'DD/MM/YYYY','Invalid Date.Please Re-Enter')"  onChange="javascript:while(''+this.value.charAt(this.value.length-1)==' ')this.value=this.value.substring(0,this.value.length-1);">
		...
		<a   onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" onclick="button_onclick(document.frm.passport_expire_date);">
 		...
 		<!-- change done by shiv on  07-Jun-07 close -->  
    ...
    <tr align="left">
     ...
     <td class="formtr1"><table width="177" border="0" cellspacing="0" cellpadding="0">
        <tr>
	  ...
	  <td class="formtr1"><input type="text" name="passport_DOB" size="10" maxlength="50" class="textBoxCss" onFocus="javascript:vDateType='DD/MM/YYYY'" onKeyUp="DateFormat(this,this.value,event,false,'DD/MM/YYYY','Invalid Date.Please Re-Enter')" onBlur="DateFormat(this,this.value,event,true,'DD/MM/YYYY','Invalid Date.Please Re-Enter')"  onChange="javascript:while(''+this.value.charAt(this.value.length-1)==' ')this.value=this.value.substring(0,this.value.length-1);">
		...
		<!-- <img src="images/calender.png?buildstamp=2_0_0" name="imageField" width="26" height="19" border="0" align="absmiddle">   -->
			...
			<!-- change done by shiv on  07-Jun-07 open -->  
				 ...
				 <IMG   height=14 alt=Calender src="images/calender.png?buildstamp=2_0_0"  width=17></a> </td>
		  <!-- change done by shiv on  07-Jun-07 close -->  
		         <script language="javascript">
   ...
   <!-- <tr align="left">
      <td class="formtr1">Date of Expiry </td>
      <td class="formtr1"></td>
      <td class="formtr1">DOB<font size="" color="#FF3300">*</font>(dd / mm / yyyy)</td>
      <td class="formtr1"><input type="text" name="passport_DOB" size="10" maxlength="50" class="textBoxCss" onFocus="javascript:vDateType='DD/MM/YYYY'" onKeyUp="DateFormat(this,this.value,event,false,'DD/MM/YYYY','Invalid Date.Please Re-Enter')" onBlur="DateFormat(this,this.value,event,true,'DD/MM/YYYY','Invalid Date.Please Re-Enter')"  onChange="javascript:while(''+this.value.charAt(this.value.length-1)==' ')this.value=this.value.substring(0,this.value.length-1);">
        <a href="javascript:show_calendar('frm.passport_DOB','a','a','DD/MM/YYYY');"onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;"><img src="images/calender.png?buildstamp=2_0_0" name="imageField" width="26" height="19" border="0" align="absmiddle"> </a> </td>
      <script language="javascript">
			document.frm.passport_DOB.value ="<%= passport_DOB %>";
			</script>
    </tr>-->
...
<!-- CHANGE COMPLETE BY SAMIR ON 13/03/2007-->
