...
<%
	...
	if (reportFlag.equalsIgnoreCase("false") && strUserAccessCheckFlag.equals("420")) {
		...
		securityUtilityBean.registerUnauthAccessLog(Suser_id,
				...
				"Group_T_TravelRequisitionDetails.jsp",
				"Unauthorized Access");
...
<body>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
 	...
 	if (travelType.equals("I"))
 			out.print(dbLabelBean
 					.getLabel(
 							"label.requestdetails.internationaljourneyreportgroupguest",
 							strsesLanguage));

 		else
 			out.print(dbLabelBean
 					.getLabel(
 							"label.requestdetails.domesticjourneyreportgroupguest",
 							strsesLanguage));
 %>
					...
					<tr align="right">
						<td>
							<ul id="list-nav">
								...
								%>
								<li><a href="#"
									onClick="MM_openBrWindow('Group_T_TravelRequisitionDetails.jsp?purchaseRequisitionId=<%=requestInfoObj.getLinkedTravelRequest()%>&traveller_Id=<%=strTravellerId%>&travelType=I','LinkedCancelledRequest<%=requestInfoObj.getLinkedTravelRequest()%>','scrollbars=yes,resizable=yes,width=975,height=550')"><%=dbLabelBean.getLabel(
			...
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					<tr>
						...
						"label.requestdetails.basicinformationoforiginator",
						strsesLanguage)%></td>
					</tr>
					<tr>
						...
						<td width="20%" height="0" class="reportdata"><%=traveller.getFirstName().toUpperCase()%>
							<%=traveller.getLastName().toUpperCase()%></td>
					...
					<tr>
						...
						strsesLanguage)%></td>
						<td width="26%" height="0" class="reportdata"><%=requestInfoObj.getDivisionName().toUpperCase()%></td>
						<td width="12%" height="0" class="reportCaption"><%=dbLabelBean.getLabel("label.requestdetails.unit",
						strsesLanguage)%></td>
						<td width="20%" height="0" class="reportdata"><%=traveller.getUnitName().toUpperCase()%></td>
						...
						<td width="16%" height="0" class="reportdata"><%=traveller.getDepartmentName().toUpperCase()%></td>
					</tr>
					<tr>
						<td class="reportCaption" width="15%"><%=dbLabelBean.getLabel("label.global.designation",
						strsesLanguage)%></td>
						...
						<td class="reportCaption" width="15%"><%=dbLabelBean.getLabel("label.global.emailid",
						strsesLanguage)%></td>
						<td class="reportdata" width="18%"><%=traveller.getEmail()%></td>

					</tr>
					<tr>
						<td class="reportCaption" width="15%"><%=dbLabelBean.getLabel(
						"label.createrequest.costcentre", strsesLanguage)%></td>
						<td class="reportdata" width="18%"><%=traveller.getCostCenterName()%></td>
						<td class="reportCaption" width="15%"><%=dbLabelBean.getLabel("label.global.reasonfortravel",
						strsesLanguage)%></td>
						<td class="reportdata" colspan="3"><%=requestInfoObj.getReasonForTravel()%></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					style="border-collapse: collapse">
					<tr>
						<td height="0" colspan="13" class="reportHeading"><%=dbLabelBean
						.getLabel("label.global.groupguesttravelerdetail",
								strsesLanguage)%></td>
					</tr>
					<tr>
						<td class="reportCaption" width="5%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.sno",
						strsesLanguage)%></td>
						<td class="reportCaption" width="14%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.firstname",
						strsesLanguage)%></td>
						<td class="reportCaption" width="14%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.lastname",
						strsesLanguage)%></td>
						<td class="reportCaption" width="12%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.designation",
						strsesLanguage)%></td>
						<td class="reportCaption" width="5%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.dob",
						strsesLanguage)%></td>
						<td class="reportCaption" width="5%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.gender",
						strsesLanguage)%></td>
						<td class="reportCaption" width="12%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.emailid",
						strsesLanguage)%></td>
						<td class="reportCaption" width="5%" style="text-align: center;">Employee Id
						</td>
						<td class="reportCaption" width="12%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.mealpreference",
						strsesLanguage)%></td>
						<td class="reportCaption" width="8%" style="text-align: center;"><%=dbLabelBean
						.getLabel("label.requestdetails.totalamtrequired",
								strsesLanguage)%></td>
						<td class="reportCaption" width="12%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.passportnumber",
						strsesLanguage)%></td>
						<td class="reportCaption" width="5%" style="text-align: center;"><%=dbLabelBean.getLabel(
						"label.requestdetails.passportvalidupto",
						strsesLanguage)%></td>
						<td class="reportCaption" width="5%" style="text-align: center;"><%=dbLabelBean.getLabel("label.global.ecr",
						strsesLanguage)%></td>
					</tr>
					<%
						List groupTravelerList = requestInfoObj.getTravelerList();
							User user = null;
					...
					%>
					<tr>
						<td class="reportCaption" width="5%"><%=i + 1%></td>
						<td class="reportdata" width="14%"><%=user.getFirstName()%></td>
						<td class="reportdata" width="14%"><%=user.getLastName()%></td>
						<td class="reportdata" width="12%"><%=user.getDesignationName()%></td>
						<td class="reportdata" width="5%"><%=user.getDateOfBirth()%></td>
						<td class="reportdata" width="5%"><%=user.getGender()%></td>
						<td class="reportdata" width="12%"><%=user.getEmail()%></td>
						<td class="reportdata" width="5%"><%=user.getEmpCode()%></td>
						<td class="reportdata" width="12%"><%=user.getMealPreferrence()%></td>	
						<td class="reportdata" width="8%" style="text-align: right;"><%=user.getAmountRequired()%></td>
						<td class="reportdata" width="12%"><%=user.getPassport().getPassportNo()%></td>
						<td class="reportdata" width="5%"><%=user.getPassport().getDateOfExpiry()%></td>
						<td class="reportdata" width="5%"><%=user.getPassport().getEcr()%></td>
					</tr>
					<%
						}
								}
				...
				<table width="100%" border="1" cellpadding="2" cellspacing="0"
					...
					<tr>
						<td height="0" colspan="10" align="left" class="reportHeading"><%=dbLabelBean.getLabel(
							...
							strsesLanguage)%></td>
						<td height="0" colspan="4" align="left" class="reportHeading"><%=requestInfoObj.getAdvanceForex() %></td>
					</tr>
					<tr>
		...
		<tr>
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					<tr>
						<td width="4%" class="reportCaption" style="text-align: center;" nowrap="nowrap"><%=dbLabelBean.getLabel("label.global.sno",
						strsesLanguage)%></td>
		...
		<tr>
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					<tr>
						<td class="reportCaption" width="4%" align="left" style="text-align: center;" nowrap="nowrap"><%=dbLabelBean.getLabel("label.global.sno",
							strsesLanguage)%></td>
		...
		<tr>
			<td>
				<table width="100%" align="left" border="1" cellpadding="2"
					...
					<tr>
						<td class="reportCaption" width="4%" align="left" valign="top" style="text-align: center;"
