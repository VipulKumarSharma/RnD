 ...
 *Modification 			: HR and AC person on cancelation on MATA  add by shiv on 3/22/2007
						: Change in workflow in case of 'MATA'
 *Reason of Modification: 
 *Date of Modification  : 22-Mar-2007
						: 18/04/2007
 *Revision History		:
 *Editor				:Editplus
 *******************************************************/
...
if(strUserAccessCheckFlag.equals("420")){
	dbConBean.close(); 
	securityUtilityBean.registerUnauthAccessLog(Suser_id, request.getRemoteAddr(), "T_Travel_Requisition_Cancel_Post.jsp", "Unauthorized Access");
...
String strUrl = strWhichPage+"?travel_type="+strTravelType;
