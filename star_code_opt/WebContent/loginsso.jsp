...
String strFrmApp  	= request.getParameter("frmApp")==null?"other":request.getParameter("frmApp");
%>
<html>
<head>
<script language=javascript>
	...
	var strFrmApp='<%= strFrmApp%>';
	window.self.location = "https://stars.mindeservices.com/loginsso1.jsp?reqWinId="+strWinid+"&reqDomain="+strDomain+"&reqErrorCode="+strReqErrorCode+"&frmApp="+strFrmApp;
</script>
</head>
