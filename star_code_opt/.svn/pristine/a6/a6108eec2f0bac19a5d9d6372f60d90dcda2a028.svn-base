 ...
 *Modification 			:1.Add a new field for userName 
					     2.On an alert msg instead of 'site' changed to 'unit'
						 3. Design change in Date of expiry , DOB , Frequent Flyer number
						 4. Last name is not mendatory 
						 5.  Secret Question field is Mendatory 
						 6. Restricting the entry of quotes(', ", \) in the fields 
						 7. Add the  gender field .
						 8. change the calender icon(converted it to drop down selection for date)  by  shiv  on 07-Jun-07.   
						 9. Fixed the bug related to mismatch in password  by Gaurav Aggarwal on 22-Jun-2007
						...
						11. Added the Identity field on 22-Oct-07 by Shiv Sharma.
						12. Changes the name of jsp on report to function by shiv sharma on 06-11-2008
						13. Extends field length for windows user id 05-10-2009 by shiv sharma 
						14  Making windows user ID  mandotry in User Registartion page on 13-10-2009  
						15: change text domian name to network domain name on 25 feb 2010  by shiv sharma 
 ...
 *Date of Modification  : 1. 07-12-2006
						  2. 20-02-2007
						  3. 13-03-2007
						  4.19/03/2007 
						  5.11/04/2007,12/04/2007
						  6.16/04/2007
						  7.20/04/2007
 *Modified By	 :1.SACHIN GUPTA
						 2.Gaurav Aggarwal 	
						 3. SAMIR RANJAN PADHI
						 4  shiv sharma
						 5  Vijay Singh
						 7  Vijay Singh
*Editor				:Editplus
...
*Modified By					:Manoj Chand
*Date of Modification			:15 june 2011
*Modification					:change color of unit combobox.
...
%>
	...
	<SCRIPT language="JavaScript" src="ScriptLibrary/popcalendar-div.js?buildstamp=2_0_0"></SCRIPT><!-- added on 14-May-14 by Gurmeet Singh -->
...
///2/28/2007
	...
	String Desig_ID 			= (request.getParameter("designation")==null || request.getParameter("designation").equals("null") || request.getParameter("designation").equals(""))?"-1":request.getParameter("designation");
...
//
    ...
    // Added by shiv sharma  on 23-Oct-07 for getting identity proof name and number    
    ...
    rSet.close();
%>
<title><%=dbLabelBean.getLabel("label.register.userregistrationscreen",strsesLanguage)%></title>
...
//			
			...
			//2/28/2007 open Adding Employee Code 
			if( f1.empcode.value == '')
			{
			 ...
			 //added by shiv sharma  on 22-10-2007 
			...
			//added by shiv sharma  on 13-10-2009
			//winUserID 
...
//end here
			...
			var gender1=document.frm.gender.value;
				document.frm.action="M_UserRegister.jsp?gender="+gender1+"&lang1="+"<%=strsesLanguage%>"; //change by vijay on 20/04/2007
...
//new 16-02-2007 sachin
		...
		function dept_Head(filename,k)
		{
         ...
         {//added the secret answer field for encript password @Vijay 11/04/2007
			...
			//var secret_answer=document.frm.ans_secret.value;
            
			var newPassword=encrypt(password);
           // var newSecret_answer=encrypt(secret_answer);
			//alert("newpassword is --->"+newPassword+ " length is---->"+newPassword.length);
			document.frm.password.value=newPassword;
			//document.frm.ans_secret.value=newSecret_answer;
			//alert("Encrypted pwd with key is being sent to request "+newPassword);
			//alert("Encrypted pwd with key is being sent to request "+newSecret_answer);
            return true;
         }
        ...
        function guestFieldEnable(){
        
        
        alert("hi");
        var gender1=document.frm.gender.value;
			document.frm.action="M_UserRegister.jsp?&gender="+gender1+""; //change by vijay on 20/04/2007
			document.frm.designation.value="-1";
			document.frm.department.value="-1";
			document.frm.submit();
...
<!-- Start of body -->
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="10">
      ...
      <table width="95%" align="center" border="0" cellpadding="5" cellspacing="0" class="formborder">
    <tr align="left">
      <td class="selectedmenubg" width="88%"><ul class="pagebullet">
        <% if (strFlag == null){ %>
          <li class="pageHead"><%=dbLabelBean.getLabel("label.register.registeryourself",strsesLanguage)%> </li>
        <% } else {%>
        </ul>
	...
	<div id="targetDiv" style="margin:0 auto; width:95%; height:520px; overflow-y:scroll;">
    <table width="100%" align="center" border="0" cellpadding="2" cellspacing="1" class="formborder">   
    <tr align="left" valign="top">
      <td colspan="3" class="dataLabel"><%=dbLabelBean.getLabel("label.register.createyouruserid",strsesLanguage)%></td><td   class="dataLabel">  </td>
    </tr>
    <tr align="left">
    ...
    <tr align="left"> 
      <td width="20%" class="formtr1"><font size="" color="#FF3300">* </font><%=dbLabelBean.getLabel("label.global.firstname",strsesLanguage)%><br> 
      </td>
      <td width="317" class="formtr1"><input type="text" name="firstName" id="fname" size="25" onKeyUp="return test1('firstName', 29, 'c')" maxlength="30" class="textBoxCss" /> <%=dbLabelBean.getLabel("label.mylinks.asperpassport",strsesLanguage)%></td>
      <script language="javascript">
			document.frm.firstName.value ="<%=txtFirstName%>"; 
			</script>
      <td width="100" class="formtr1"><font size="" color="#FF3300"></font>&nbsp;&nbsp;&nbsp;<%=dbLabelBean.getLabel("label.mylinks.middlename",strsesLanguage)%> </td>
      <td width="493" class="formtr1"><input type="text" name="middleName" size="25" onKeyUp="return test1('middleName', 29, 'c')" maxlength="30" class="textBoxCss" /> 
	...
	<%			} %>	
      ...
      <td width="317" class="formtr1"><input type="text" name="lastName" id="lname" size="25" onKeyUp="return test1('lastName', 29, 'c')" maxlength="30" class="textBoxCss" />     
      <%=dbLabelBean.getLabel("label.mylinks.asperpassport",strsesLanguage)%> </td>
      <script language="javascript">
			document.frm.lastName.value ="<%=txtLastName%>";
			</script>
      <td width="100" class="formtr1">  <font size="" color="#FF3300">* </font><%=dbLabelBean.getLabel("label.global.gender",strsesLanguage)%> <br>  
     </td>
      <td width="493" class="formtr1"><select name="gender" class="textBoxCss">
				<option value="-1"></font><%=dbLabelBean.getLabel("label.global.gender",strsesLanguage)%></option>
...
<% 
//change in this query by manoj chand on 03 july 2012 to show only active unit not closed.
...
<%	
	query = "SELECT DESIG_ID,DESIG_NAME  FROM M_DESIGNATION where site_id="+Site_ID+" AND APPLICATION_ID=1 AND STATUS_ID = 10 ORDER BY DESIG_NAME";
 		rs = bean.executeQuery(query); 
%>
...
%>
	  ...
	  <!-- Adding employee code  2/28/2007 -->
	  ...
	  <!-- 10/17/1998  Proof of Identity -->
	  <tr align="left">
        <td class="formtr1">&nbsp;&nbsp;&nbsp;<%=dbLabelBean.getLabel("label.global.proofofidentity",strsesLanguage)%></td><td class="formtr1">
		...
		<td class="formtr1">&nbsp;&nbsp;&nbsp;<%=dbLabelBean.getLabel("label.createrequest.identityproofnumber",strsesLanguage)%> 
		 </td>
		
		<td class="formtr1">
		<input type='text' name='identityProofno' value="<%=strIdentityProofNo%>" class="textBoxCss" onKeyUp="return test1('identityProofno', 30, 'all')"/></td>
    </tr>
			<script language="javascript">
			       //alert('<%=strIdentityProofNo%>'); 				   
				   if('<%=strIdentityProofNo%>'=='') 
				   {
					  document.frm.identityProofno.value="";
				   }
				   else
				   {
	  ...
	  <!-- Adding employee code  2/28/2007 end -->
     
     <!-- added new on 03-02-2009 by shiv sharma  open --> 
      ...
      <tr>
					...
					<td class="formtr1"><font size="" color="#FF3300">* </font><%=dbLabelBean.getLabel("label.mylinks.windowsuserid",strsesLanguage)%></td><td width="328" class="formtr1">
						<input type='text' name='winUserID' value="<%=strWindowsUserId%>"  class="textBoxCss"  onKeyUp="return test1('winUserID', 50, 'all')"/></td> 
					 ...
					 <td class="formtr1"><font size="" color="#FF3300">* </font><%=dbLabelBean.getLabel("label.mylinks.networkdomainname",strsesLanguage)%>  </td>
							  <td class="formtr1">
									<input type='text' name='domainname' value="<%=strNetworkDomainName%>"  class="textBoxCss" onKeyUp="return test1('domainname', 50, 'All')"/></td>
     ...
     <!-- added new on 03-02-2009 by shiv sharma  close -->
    ...
    <tr>
      ...
      <td class="formtr1"><input type="password" name="ans_secret" size="34" onKeyUp="return test1('ans_secret', 20, 'pwd');" maxlength="15" class="textBoxCss" /></td>
    ...
    <tr align="center">
      <td width="181" class="formtr1"><%=dbLabelBean.getLabel("label.createrequest.passportnumber",strsesLanguage)%></td>
      <td width="317" class="formtr1"><input type="text" name="passport_No" size="25" onKeyUp="return test1('passport_No', 49, 'all')" maxlength="10" class="textBoxCss" /></td>
      <script language="javascript">
			document.frm.passport_No.value ="<%= passport_No %>";
			</script>
	   <td width="175" class="formtr1"><%=dbLabelBean.getLabel("label.user.nationality",strsesLanguage)%></td>
       <td width="493" class="formtr1"><input type="text" name="nationality" size="25" onKeyUp="return test1('nationality', 50, 'all')" maxlength="50" class="textBoxCss" /></td>
      <script language="javascript">
...
<!--
 ...
 CHANGE BY SAMIR RANJAN PADHI ON (13/03/2007)
 CHANGE USE FOR VIEW DISIGNING 
 REASON FOR CHANGING : ALLIGNMENT SETTING
...
-->
   ...
   <tr align="center">
	...
	%>  </select>
      ...
      <td class="formtr1"><input type="text" name="passport_issue_place" size="25" onKeyUp="return test1('passport_issue_place', 99, 'c')" maxlength="25" class="textBoxCss" /></td>
	  <script language="javascript">
    ...
    <tr align="left">
      ...
      <td class="formtr1"><input type="text" name="passport_issue_date" size="10" maxlength="10" class="textBoxCss" onFocus="javascript:vDateType='DD/MM/YYYY'" onKeyUp="DateFormat(this,this.value,event,false,'DD/MM/YYYY','Invalid Date.Please Re-Enter')" onBlur="DateFormat(this,this.value,event,true,'DD/MM/YYYY','Invalid Date.Please Re-Enter')"  onChange="javascript:while(''+this.value.charAt(this.value.length-1)==' ')this.value=this.value.substring(0,this.value.length-1);">
    	 <a id="passportCalIss"  onMouseOver="window.status='Date Picker';return true;"   onMouseOut="window.status='';return true;"  onclick="button_onclick(document.frm.passport_issue_date);" > <IMG   height=14 alt="<%=dbLabelBean.getLabel("label.register.calender",strsesLanguage)%>" src="images/calender.png?buildstamp=2_0_0"  width=17></A>
	  </td>
         <script language="javascript">
      ...
      <td class="formtr1"><input type="text" name="passport_expire_date" size="10" maxlength="50" class="textBoxCss" onFocus="javascript:vDateType='DD/MM/YYYY'" onKeyUp="DateFormat(this,this.value,event,false,'DD/MM/YYYY','Invalid Date.Please Re-Enter')" onBlur="DateFormat(this,this.value,event,true,'DD/MM/YYYY','Invalid Date.Please Re-Enter')"  onChange="javascript:while(''+this.value.charAt(this.value.length-1)==' ')this.value=this.value.substring(0,this.value.length-1);">
		<a  id="passportCalExp" onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;" onclick="button_onclick(document.frm.passport_expire_date);">
		 <IMG height=14 alt="<%=dbLabelBean.getLabel("label.register.calender",strsesLanguage)%>" src="images/calender.png?buildstamp=2_0_0"   width=17></a>
 		 <script language="javascript">document.frm.passport_expire_date.value ="<%= passport_expire %>";
			</script></td>
    </tr>
    ...
    <tr align="left">
	  ...
	  <!-- change the size of  maxlength from 12 to 20 in Frequent Flyer Number of Airline Names,Airline Number on 04-Jul-07 by shiv  open-->
     ...
     <td class="formtr1">
     	<table width="177" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
	  		  	<td width="88" align="center" class="formtr1"><input type="text" name="airLineName" size="15" maxlength="20"  onKeyUp="return test1('airLineName', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	          	<td width="89" align="center" class="formtr1"><input type="text" name="passport_flight_No" size="18" maxlength="20"  onKeyUp="return test1('passport_flight_No', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
			</tr>
	        <tr>          
	          	<td align="center" class="formtr1"><input type="text" name="airLineName1" size="15" maxlength="20"  onKeyUp="return test1('airLineName1', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
			  	<td align="center" class="formtr1"><input type="text" name="passport_flight_No1" size="18"  maxlength="20" onKeyUp="return test1('passport_flight_No1', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	        </tr>
	        <tr>
		    	<td align="center" class="formtr1"><input type="text" name="airLineName2" size="15" maxlength="20"  onKeyUp="return test1('airLineName2', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	            <td align="center" class="formtr1"><input type="text" name="passport_flight_No2" size="18"  maxlength="20" onKeyUp="return test1('passport_flight_No2', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	        </tr>
	        <tr>
		    	<td align="center" class="formtr1"><input type="text" name="airLineName3" size="15" maxlength="20" onKeyUp="return test1('airLineName3', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	           	<td align="center" class="formtr1"><input type="text" name="passport_flight_No3" size="18" maxlength="20"  onKeyUp="return test1('passport_flight_No3', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	        </tr>
	        <tr>
		    	<td align="center" class="formtr1"><input type="text" name="airLineName4" size="15" maxlength="50"  onKeyUp="return test1('airLineName4', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	            <td align="center" class="formtr1"><input type="text" name="passport_flight_No4" size="18" maxlength="50"  onKeyUp="return test1('passport_flight_No4', 20, 'cn')" maxlength="20" class="textBoxCss" /></td>
	        </tr>
			   <script language="javascript">
				...
				document.frm.passport_flight_No3.value ="<%= passport_FNo4 %>";
			</script>
      	</table>
      </td>
     ...
     <td class="formtr1">
     	<table width="177" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
	          	<td width="88" align="center" class="formtr1"><input type="text" name="hotelChain" size="15"  maxlength="20" onKeyUp="return test1('hotelChain', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	          	<td width="89" align="center" class="formtr1"><input type="text" name="hotelNumber" size="18"   maxlength="20" onKeyUp="return test1('hotelNumber', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
			</tr>
	        <tr>          
			  	<td align="center" class="formtr1"><input type="text" name="hotelChain1" size="15"  maxlength="20" onKeyUp="return test1('hotelChain1', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	          	<td align="center" class="formtr1"><input type="text" name="hotelNumber1" size="18"  maxlength="20" onKeyUp="return test1('hotelNumber1', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	        </tr>
	        <tr>
	            <td align="center" class="formtr1"><input type="text" name="hotelChain2" size="15" maxlength="20"  onKeyUp="return test1('hotelChain2', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	            <td align="center" class="formtr1"><input type="text" name="hotelNumber2" size="18" maxlength="20"  onKeyUp="return test1('hotelNumber2', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	        </tr>
	        <tr>
				<td align="center" class="formtr1"><input type="text" name="hotelChain3" size="15" maxlength="20"  onKeyUp="return test1('hotelChain3', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	        	<td align="center" class="formtr1"><input type="text" name="hotelNumber3" size="18"  maxlength="20" onKeyUp="return test1('hotelNumber3', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	        </tr>
	        <tr>
				<td align="center" class="formtr1"><input type="text" name="hotelChain4" size="15"  maxlength="50" onKeyUp="return test1('hotelChain4', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	            <td align="center" class="formtr1"><input type="text" name="hotelNumber4" size="18" maxlength="50"  onKeyUp="return test1('hotelNumber4', 20, 'cn')" maxlength="20" class="textBoxCss" />          </td>
	        </tr>
			   <script language="javascript">
    ...
    <tr align="left">
      ...
      <td valign="top" class="formtr1"><span class="label2">
        <textarea name="passport_address" rows="5" cols="30" id="passport_address" onKeyUp="return test1('passport_address',200, 'txt')"></textarea>
      </span></td>
      <script language="javascript">
      ...
      <td valign="top" class="formtr1"><span class="label2">
        <textarea name="current_address" rows="5" cols="30" id="textarea" onKeyUp="return test1('current_address',200, 'txt')"></textarea>
      </span>
	  </td>
	  <script language="javascript">
    ...
    <tr align="center">
      	<td colspan="4" class="formBottom">
      		<input type="submit" name="Submit" value="<%=dbLabelBean.getLabel("label.register.register",strsesLanguage)%>"   onClick="return checkData(this.form)"  class="formButton" > 
